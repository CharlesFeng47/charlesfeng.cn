...
+ **Timeliness**
  ...
  + 当考虑及时性的时候，也需要考虑 replication latency 的影响。发生在一个 DC 上的更新并不会立刻被 replicate 到另一个 DC 上。因此，要求在跟踪时的及时性远优于预期的 replication latency 通常不会给应用带来真正的益处。<u>*（注：说人话就是过度追求及时性、甚至要求它高于 replication latency 是不现实的）*</u>
